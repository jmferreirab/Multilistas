========================================================================
   APLICACIÓN: Multilistas Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Multilistas.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Multilistas.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Multilistas.pch y un archivo de tipos 
